        ...
        <form onSubmit={handleSave} className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none transition-all font-medium" 
                  placeholder="912..." 
                />
              </div>
            </div>
            <div className="space-y-1">
              ...
              <div className="px-4 py-3 bg-slate-100 text-slate-500 rounded-2xl font-bold text-sm text-center">Contrato Normal</div>
            </div>
          </div>
          ...
          <div className="space-y-2">
            <label className="text-xs font-black text-slate-400 uppercase ml-1 flex items-center gap-2">
              <Heart className="w-3 h-3" /> Necessidades de Cuidado
            </label>
          ...
          <button 
            disabled={loading} 
            type="submit" 
            className="w-full py-4 bg-slate-900 text-white rounded-2xl font-black text-lg shadow-xl shadow-slate-200 hover:bg-indigo-600 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
          >
